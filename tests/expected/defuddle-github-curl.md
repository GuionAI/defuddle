```json
{
  "title": "kepano/defuddle: Extract the main content from web pages.",
  "author": "kepano",
  "site": "GitHub",
  "published": ""
}
...
[MIT license](/kepano/defuddle/blob/main/LICENSE)

[Branches](/kepano/defuddle/branches) [Tags](/kepano/defuddle/tags)> de·fud·dle /diˈfʌdl/ *transitive verb*  
...
Cleaned up string of the extracted content
...
Time taken to parse the page in milliseconds
...
Raw schema.org data extracted from the page
...
Keep `content` as HTML and return `contentMarkdown` as Markdown
...
[Activity](/kepano/defuddle/activity)

[**3k** stars](/kepano/defuddle/stargazers)

[**9** watching](/kepano/defuddle/watchers)

[**101** forks](/kepano/defuddle/forks)

[Report repository](/contact/report-content?content_url=https%3A%2F%2Fgithub.com%2Fkepano%2Fdefuddle&report=kepano+%28user%29)

## Releases 27

[\+ 26 releases](/kepano/defuddle/releases)
...
- [TypeScript 95.9%](/kepano/defuddle/search?l=typescript)
- [HTML 3.2%](/kepano/defuddle/search?l=html)
- [JavaScript 0.9%](/kepano/defuddle/search?l=javascript)